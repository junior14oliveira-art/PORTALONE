  ...
  return (
    <html lang="pt-BR" suppressHydrationWarning className="bg-background text-foreground">
      <body className={`font-sans antialiased min-h-screen flex flex-col`}>
        ...
        <a href="https://wa.me/5511910345060" target="_blank" rel="noopener noreferrer" className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all" aria-label="Contato via WhatsApp">
