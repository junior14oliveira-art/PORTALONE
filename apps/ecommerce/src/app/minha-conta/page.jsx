...
export default function LoginPage() {
  ...
  const handleCredentialsLogin = async (e) => {
    ...
    await signIn('credentials', {
      email,
      password,
      callbackUrl: '/minha-conta/pedidos'
    });
    setIsLoading(false);
  };

  const handleGoogleLogin = () => {
    signIn('google', { callbackUrl: '/minha-conta/pedidos' });
  };
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-2 border border-border rounded-md shadow-sm placeholder-muted focus:outline-none focus:ring-brand focus:border-brand sm:text-sm bg-background text-foreground"
                />
              </div>
            </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-muted">Ou continue com</span>
              </div>
            </div>
            ...
            <div className="mt-6">
              <button
                ...
                className="w-full inline-flex justify-center py-2.5 px-4 border border-border rounded-md shadow-sm bg-white text-sm font-medium text-foreground hover:bg-muted-bg transition-colors items-center gap-3"
              >
